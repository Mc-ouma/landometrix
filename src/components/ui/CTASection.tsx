...
const CTASection = () => {
  return (
    <section className="py-16 md:py-24 px-6 md:px-12 mb-20">
          ...
          <div className="relative px-6 py-10 md:p-12 text-center md:text-left">
            ...
            <div className="relative md:flex items-center justify-between">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-end">
                <Link
                  href="/contact"
                  className="bg-white hover:bg-gray-100 text-blue-600 font-medium px-8 py-3 rounded-md text-center transition-colors hover-lift"
                >
                  Contact Us
                </Link>
                <Link
                  href="/services"
                  className="bg-blue-700 hover:bg-blue-800 text-white font-medium px-8 py-3 rounded-md border border-blue-500 text-center transition-colors hover-lift"
                >
                  Our Services
                </Link>
              </div>
