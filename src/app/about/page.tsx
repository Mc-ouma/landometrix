...
const AboutPage = () => {
  ...
  return (
    <div>
      ...
      <section className="bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 py-20">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">About Landometrix</h1>
      ...
      <section className="py-20 px-6 md:px-12 bg-gray-50 dark:bg-gray-900">
        <div className="max-w-7xl mx-auto">
              ...
              >
                <div className="relative mb-6 overflow-hidden rounded-2xl">
                  ...
                  <div className="aspect-[4/5] overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900 dark:to-indigo-900 relative">
                      <Image 
                        src="/images/team-placeholder.svg"
                        alt={member.name}
                        fill
                        className="object-cover object-center mix-blend-overlay dark:mix-blend-soft-light"
                      />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-4 translate-y-full group-hover:translate-y-0 transition-transform duration-300 ease-in-out">
                    <div className="flex justify-center space-x-3">
                      <a href="#" className="w-8 h-8 bg-white dark:bg-gray-800 rounded-full flex items-center justify-center text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">
          ...
          <div className="mt-16 text-center">
            <a href="/careers" className="inline-flex items-center text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300">
      ...
      {/* CTA Section */}
      <section className="py-16 px-6 md:px-12 bg-gradient-to-br from-blue-600 to-blue-700 text-white">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <Link
            href="/contact"
            className="bg-white hover:bg-gray-100 text-blue-600 font-medium px-8 py-3 rounded-md inline-block transition-colors"
          >
            Get in touch
          </Link>
        </div>
