              ...
              <div className="space-y-8">
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">123 Data Drive</p>
                    <p className="text-gray-700 dark:text-gray-300">San Francisco, CA 94105</p>
                  </div>
                </div>
                ...
                <div className="flex">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-700 dark:text-gray-300">Monday - Friday: 9am - 5pm PST</p>
          ...
          <div className="bg-theme-surface-1 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden">
            <div className="aspect-video bg-gray-200 dark:bg-gray-700 rounded-lg flex items-center justify-center">
              <div className="text-center p-8">
                ...
                <p className="text-gray-600 dark:text-gray-300">Interactive map placeholder - would be implemented with Google Maps or another mapping service</p>
              </div>
            </div>
          </div>
        </AnimateOnScroll>
